  ...
  render() {
    return (
      <div>
        ...
        <p>Given my background in Computing, Web Development and Programming, alongside 8 years working within the Systems Support industry,  I have developed the knowledge and resources to cover teaching at all ages: from Primary School to A-Level, and beyond.</p>

        <p>Everyone learns in a slightly different way and at different speeds so my lessons are diverse, structured around and tailored to students' needs. Some lessons are highly structured, where a new concept is taught or practice is required; others are less structured to enable development of independent skills, such as problem-solving, resilience to adversity or searching for the correct code modules to incorporate into a program.  All of these are crucial components in enabling students to become good programmers and problem solvers.</p>
      </div>
    );
  }
}
